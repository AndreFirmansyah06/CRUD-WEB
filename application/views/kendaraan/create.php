                ...
                <div class="col-10">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="d-lg-inline">Tambah Unit Kendaraan</h4>
                        </div>

                        <div class="card-body">
                            <form action="<?= site_url('kendaraan/create'); ?>" method="POST" role="form">
                                ...
                                <div class="form-group row">
                                    <label for="brand" class="col-sm-2 col-form-label">Pabrikan</label>
                                    <div class="col-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" name="transmisi" id="transmisi" class="form-control" value="<?= set_value('transmisi'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <a href="<?= site_url('kendaraan/index'); ?>" class="btn btn-default btn-block">Kembali</a>
                                </div>
                            </form>
                        </div>
                    </div>
