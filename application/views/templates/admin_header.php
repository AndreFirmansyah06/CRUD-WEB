...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <aside class="main-sidebar sidebar-light-dark elevation-4 ">
        <!-- Brand Logo -->
        <a href="<?= site_url('home'); ?>" class="brand-link navbar-dark">
            <img src="<?= base_url('assets/'); ?>dist/img/Yamaha.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8;">
            <span class="brand-text font-weight-light text-light">Bahagia Putra Motor</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">Admin Dealer</a>
                </div>
            </div>
            <!-- Sidebar Menu -->
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
                    ...
                    <li class="nav-item navbar-light">
                        <a href="<?= site_url('kendaraan'); ?>" class="nav-link <?= $this->uri->segment(1) == 'kendaraan' ? 'active' : ''; ?>">
                            <i class="nav-icon far fa-edit"></i>
                            <p>Ubah Unit Kendaraan</p>
                        </a>
                    </li>
                    <li class="nav-item navbar-light">
                        <a href="<?= site_url('Home_SparePart'); ?>" class="nav-link <?= $this->uri->segment(1) == 'Home_SparePart' ? 'active' : ''; ?>">
